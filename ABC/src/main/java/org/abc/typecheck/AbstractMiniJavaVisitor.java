...
public abstract class AbstractMiniJavaVisitor {
    ...
    public Object visit(CommonTree tree) {
        ...
        case ABCLexer.ARRAY_TYPE:
            return visitArrayType(tree);
        ...
        case ABCLexer.INTARRAY_NEW:
            return visitIntArrayNew(tree);
        case ABCLexer.IF:
            return visitIF(tree);
        ...
        case ABCLexer.ARRAYLENGTH_REFERENCE:
            return visitArrayLengthReference(tree);
