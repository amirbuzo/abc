// The classes are basically the same as the BinaryTree3
...
class Tree3 {
    ...
    public boolean SetRight(Tree3 rn) {
        right = rn;
        return true;
    }

    public boolean SetLeft(Tree3 ln) {
        left = ln;
        return true;
    }
    ...
    public boolean Remove(Tree3 p_node, Tree3 c_node) {
        boolean ntb;
        int auxkey1;
        int auxkey2;
    ...
    public boolean RemoveRight(Tree3 p_node, Tree3 c_node) {
        boolean ntb;
    ...
    public boolean RemoveLeft(Tree3 p_node, Tree3 c_node) {
        boolean ntb;
    ...
    public boolean RecPrint(Tree3 node) {
        boolean ntb;
